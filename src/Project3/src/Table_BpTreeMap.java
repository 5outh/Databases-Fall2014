       ...
       implements Serializable
{
     ...
     */  
    public Table_BpTreeMap (String _name, String [] _attribute, Class [] _domain, String [] _key)
    {
        name      = _name;
    ...
    public Table_BpTreeMap project (String attributes)
    {
        ...
        return new Table_BpTreeMap (name + count++, attrs, colDomain, newKey, rows);
    } // project
   ...
   public Table_BpTreeMap union (Table_BpTreeMap table2)
     ...
     */
       public List<Comparable[]> compareOperation(Table_BpTreeMap table2, String operation){
    ...
    public Table_BpTreeMap join (String attributes1, String attributes2, Table_BpTreeMap table2)
    {
        ...
        return new Table_BpTreeMap (name + count++, attrs, dom, key, rows);
    } // join
     ...
     */
    public static Table_BpTreeMap load (String name)
    {
        Table_BpTreeMap tab = null;
        try {
            ObjectInputStream ois = new ObjectInputStream (new FileInputStream (DIR + name + EXT));
            tab = (Table_BpTreeMap) ois.readObject ();
            ois.close ();
     ...
     */
    private boolean compatible (Table_BpTreeMap table2)
    {
