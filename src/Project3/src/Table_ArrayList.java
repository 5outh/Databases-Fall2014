       ...
       implements Serializable
{
     ...
     */  
    public Table_ArrayList (String _name, String [] _attribute, Class [] _domain, String [] _key)
    {
        name      = _name;
    ...
    public Table_ArrayList project (String attributes)
    {
        ...
        return new Table_ArrayList (name + count++, attrs, colDomain, newKey, rows);
    } // project
   ...
   public Table_ArrayList union (Table_ArrayList table2)
     ...
     */
       public List<Comparable[]> compareOperation(Table_ArrayList table2, String operation){
    ...
    public Table_ArrayList join (String attributes1, String attributes2, Table_ArrayList table2)
    {
        ...
        return new Table_ArrayList (name + count++, attrs, dom, key, rows);
    } // join
     ...
     */
    public static Table_ArrayList load (String name)
    {
        Table_ArrayList tab = null;
        try {
            ObjectInputStream ois = new ObjectInputStream (new FileInputStream (DIR + name + EXT));
            tab = (Table_ArrayList) ois.readObject ();
            ois.close ();
     ...
     */
    private boolean compatible (Table_ArrayList table2)
    {
