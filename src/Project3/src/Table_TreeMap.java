       ...
       implements Serializable
{
     ...
     */  
    public Table_TreeMap (String _name, String [] _attribute, Class [] _domain, String [] _key)
    {
        name      = _name;
     ...
     */
    public Table_TreeMap (String name, String attributes, String domains, String _key)
    {
     ...
     */
    public Table_TreeMap project (String attributes)
    {
        ...
        return new Table_TreeMap (name + count++, attrs, colDomain, newKey, rows);
    } // project
     ...
     */
    public Table_TreeMap select (Predicate <Comparable []> predicate)
    {
        ...
        return new Table_TreeMap (name + count++, attribute, domain, key, rows);
    } // select
     ...
     */
    public Table_TreeMap select (KeyType keyVal)
    {
        List<Comparable[]> rows = new ArrayList<>();
     ...
     */
   public Table_TreeMap union (Table_TreeMap table2)
    {
     ...
     */
    public Table_TreeMap minus (Table_TreeMap table2)
    {
        if (! compatible (table2)) return null;
     ...
     */
       public List<Comparable[]> compareOperation(Table_TreeMap table2, String operation){
     ...
     */
    public Table_TreeMap join (String attributes1, String attributes2, Table_TreeMap table2)
    {
        ...
        return new Table_TreeMap (name + count++, attrs, dom, key, rows);
    } // join
     ...
     */
    public static Table_TreeMap load (String name)
    {
        Table_TreeMap tab = null;
        try {
            ObjectInputStream ois = new ObjectInputStream (new FileInputStream (DIR + name + EXT));
            tab = (Table_TreeMap) ois.readObject ();
            ois.close ();
     ...
     */
    private boolean compatible (Table_TreeMap table2)
    {
