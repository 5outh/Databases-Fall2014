       ...
       implements Serializable
{
    ...
    /**Number of buckets to init the extmap with
     */
    private final int DEFAULT_BUCKETS = 2;
     ...
     */  
    public Table_ExtHashMap (String _name, String [] _attribute, Class [] _domain, String [] _key)
    {
        name      = _name;
        ...
        index     = new ExtHashMap <KeyType, Comparable []> (KeyType.class, Comparable[].class, DEFAULT_BUCKETS);       // also try BPTreeMap, LinHashMap or ExtHashMap
    } // constructor
     ...
     */
    public Table_ExtHashMap (String name, String attributes, String domains, String _key)
    {
    ...
    public Table_ExtHashMap project (String attributes)
    {
        ...
        return new Table_ExtHashMap (name + count++, attrs, colDomain, newKey, rows);
    } // project
   ...
   public Table_ExtHashMap union (Table_ExtHashMap table2)
     ...
     */
       public List<Comparable[]> compareOperation(Table_ExtHashMap table2, String operation){
    ...
    public Table_ExtHashMap join (String attributes1, String attributes2, Table_ExtHashMap table2)
    {
        ...
        return new Table_ExtHashMap (name + count++, attrs, dom, key, rows);
    } // join
     ...
     */
    public static Table_ExtHashMap load (String name)
    {
        Table_ExtHashMap tab = null;
        try {
            ObjectInputStream ois = new ObjectInputStream (new FileInputStream (DIR + name + EXT));
            tab = (Table_ExtHashMap) ois.readObject ();
            ois.close ();
     ...
     */
    private boolean compatible (Table_ExtHashMap table2)
    {
